...
public class RedisMapTest extends BaseTest {
    ...
    @Test
    public void testSet() {
        RedisMap<Student, Student> map = new RedisMap<>(redisPool, KEY_SPACE, RedisKeyType.normal(), new RedisValueInstance<>(Student.class, new FastJsonSerializer()));
    ...
    public void testSet_2() {
        RedisMap<Men, Men> map = new RedisMap<>(redisPool, KEY_SPACE, RedisKeyType.normal(), new RedisValueInstance<>(Men.class, new FastJsonSerializer()));
